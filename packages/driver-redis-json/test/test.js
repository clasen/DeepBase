...
describe('RedisDriver', function() {
  ...
  describe('Basic Operations', function() {
    ...
    it('should allow updating a field after setting an object', async function() {
      await db.set('value', { a: 1, b: 1 });
      await db.set('value', 'a', 2);
      
      const value = await db.get('value');
      assert.deepStrictEqual(value, { a: 2, b: 1 });
    });
  ...
  describe('Keys with Special Characters', function() {
    ...
    it('should delete keys containing special characters', async function() {
