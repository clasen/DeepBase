...
async function benchmark() {
  console.log('\n═══════════════════════════════════════════════════════════');
  console.log('  DeepBase Redis-JSON Driver - Performance Benchmark');
  console.log('═══════════════════════════════════════════════════════════\n');

  const db = new DeepBase(new RedisDriver({ 
    url: 'redis://localhost:6379',
    prefix: 'benchmark-json'
  }));
  ...
  // 4. Increment Performance (uses JSON.NUMINCRBY - atomic!)
  console.log('➕ Testing INCREMENT performance (JSON.NUMINCRBY - atomic)...');
  ...
  // 11. Concurrent Increments (JSON.NUMINCRBY - atomic)
  console.log('➕ Testing CONCURRENT INCREMENTS (JSON.NUMINCRBY - atomic)...');
  ...
  // Summary
  console.log('═══════════════════════════════════════════════════════════');
  console.log('  SUMMARY - Redis-JSON Driver (with RedisJSON module)');
  console.log('═══════════════════════════════════════════════════════════');
  ...
  console.log(`  Concurrent Increment: ${stressOpsPerSec.toFixed(2)} ops/sec (atomic)`);
  console.log('───────────────────────────────────────────────────────────');
